    ...
    while True:
        ...
        for i in range(strip.numPixels()): # Do this once for every LED in the light strip
            ...
            while x < steps: # Repeated for every LED in the strip
                ...
                strip.setPixelColor(x - 1, Color(int(float(r) * float(75 / 100)), int(float(g) * float(75 / 100)), int(float(b) * float(75 / 100))))
                strip.setPixelColor(x - 2, Color(int(float(r) * float(50 / 100)), int(float(g) * float(50 / 100)), int(float(b) * float(50 / 100))))
                strip.setPixelColor(x - 3, Color(int(float(r) * float(25 / 100)), int(float(g) * float(25 / 100)), int(float(b) * float(25 / 100))))
